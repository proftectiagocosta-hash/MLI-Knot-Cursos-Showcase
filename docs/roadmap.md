...
## Not planned for this showcase / Não planejado para esta vitrine

This showcase should not become the production application.

Esta vitrine não deve se tornar a aplicação de produção.
